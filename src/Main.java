...
public class Main {
    ...
    public static final String REP_PHONE      = "EP";
    ...
    public static final String NOT_ALL_DIFFERENT = "There are contacts that share phone numbers.";
    ...
    private static void repeatedPhones(ContactBook cBook) {
        if(cBook.repeatedContact()) {
            System.out.println(NOT_ALL_DIFFERENT);
        }
